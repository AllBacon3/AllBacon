...
import com.AllBacon.magicfurnace.blocks.magic_furance.slots.SlotMagicFurnaceOutput;
...
public class ContainerMagicFurnace extends Container
{
	...
	public ContainerMagicFurnace(InventoryPlayer playerInventory, IInventory furnaceInventory) 
	{
		this.tileFurnace = furnaceInventory;
		this.addSlotToContainer(new Slot(furnaceInventory, 0, 56, 17));
		this.addSlotToContainer(new SlotMagicFurnaceFuel(furnaceInventory, 1, 56, 53));
		this.addSlotToContainer(new SlotMagicFurnaceOutput(playerInventory.player, furnaceInventory, 2, 116, 35));
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) 
	{
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (!MagicFurnaceRecipes.instance().getCookingResult(itemstack1).isEmpty())
                {
