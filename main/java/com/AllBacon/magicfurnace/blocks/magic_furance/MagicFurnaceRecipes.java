...
public class MagicFurnaceRecipes
{
	private static final MagicFurnaceRecipes COOKING_BASE = new MagicFurnaceRecipes();
	private final Map<ItemStack, ItemStack> cookingList = Maps.<ItemStack, ItemStack>newHashMap();
	private final Map<ItemStack, Float> experienceList = Maps.<ItemStack, Float>newHashMap();
	
	public static MagicFurnaceRecipes instance()
    {
        return COOKING_BASE;
    }
	
	private MagicFurnaceRecipes()
	{
		this.addCookingRecipeForBlock(Blocks.BED, new ItemStack(Items.APPLE), 0.6f);
	}
