package com.AllBacon.magicfurnace.blocks.magic_furance;

import com.AllBacon.magicfurnace.blocks.magic_furance.slots.SlotMagicFurnaceFuel;
...
public class TileEntityMagicFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
	...
	{
		return this.hasCustomName() ? this.furnaceCustomName : "container.magic_furnace";
	}
	...
	{
		fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityMagicFurnace.class, new String[] {"Items"}));
	}
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            {
                flag1 = true;
                MagicFurnace.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = MagicFurnaceRecipes.instance().getCookingResult(this.furnaceItemStacks.get(0));
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            ItemStack itemstack1 = MagicFurnaceRecipes.instance().getCookingResult(itemstack);
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack) 
    {
    	...
    	{
    		ItemStack itemStack = this.furnaceItemStacks.get(1);
    		return isItemFuel(stack) || SlotMagicFurnaceFuel.isBucket(stack) && itemStack.getItem() != Items.BUCKET;
    	}
    }
